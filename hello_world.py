...
prefix = d['prefix'] # This will be used at the start of commands.
embed_role = d['embed_role'] # The id of role in your server used for embedding.
game = d['game'] # This will display as the game on Discord.
